...
const ModalViewPackages = ({ setShow }) => {
  ...
  return (
    <div className='fixed inset-0 z-[200] flex px-4 md:p-0 overflow-hidden'>
      ...
      <motion.div
        ...
        initial='hidden'
        whileInView='visible'
        className='w-auto relative overflow-hidden my-5 min-h-[316px] h-auto border-l-[6px] shadow-lg border-[#f97316] rounded-3xl gap-5 flex flex-col items-center justify-between p-10 bg-[#FFFFFF] m-auto z-20 '
      >
...
export default ModalViewPackages
